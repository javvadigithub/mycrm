from .models import Inventory, InventoryGroup, Store, Invoice, InvoiceItem
from user_control.serializers import CreateUserSerializer, CustomUserSerializer
...
class StoreWithAmountSerializer(StoreSerializer):
